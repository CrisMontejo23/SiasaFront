...
const UpdateObject = () => {
  ...
  const [data, setData] = useState({
    idAudioVisual: objectData.idAudioVisual,
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch(
        `${prestamosURL}/audiovisual/update/${data.idAudioVisual}`,
        {
          method: "PATCH",
          headers: {
      ...
      if (!response.ok) {
        throw new Error("Error al actualizar el material audiovisual");
      }

      const responseData = await response.json();
      setErrorMessage(
        `Material audiovisual ${responseData.nombre} actualizado exitosamente.`
      );
      audioOk.play();
      setTimeout(() => {
        navigate("/prestamos/audioVisual/dashboard");
      }, 2500);
    } catch (error) {
      audioError.play();
  ...
  return (
    <div style={{ backgroundColor: "white" }}>
      <React.Fragment>
        ...
        >
          ACTUALIZAR MATERIAL AUDIOVISUAL
        </p>
        <br />
        {errorMessage && (
          <div
              ...
              <div className="col">
                ...
                >
                  ...
                  <a
                    ...
                    href="/prestamos/audioVisual/dashboard"
                    style={{
                      margin: "5px",
                      width: "100px",
                      boxShadow: "3px 3px 10px rgba(0, 0, 0, 1)",
