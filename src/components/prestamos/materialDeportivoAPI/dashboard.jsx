...
const Inventario = () => {
  ...
  const [sortBy, setSortBy] = useState("idMaterialDeportivo");
  ...
  const [idMaterialDeportivo, setIdMaterialDeportivo] = useState(null);
        ...
        .then((response) => {
          ...
          if (lastPrestamo.fechaDevolucion === null) {
            ...
            if (objetoSeleccionado) {
              ...
              setIdMaterialDeportivo(idInventarioMaterialDeportivo);
            } else {
        ...
        .catch((error) => {
          ...
          if (
            ...
            if (objetoSeleccionado) {
              ...
              //console.log("id", idInventarioMaterialDeportivo);
              //console.log(rfid);
  ...
  return (
    <div>
      ...
      >
        PRÉSTAMOS DE MATERIAL DEPORTIVO
      </p>
        ...
        >
          <React.Fragment>
              ...
              <form className="form-inline justify-content-center">
                <div className="form-group">
                  ...
                  <a
                    ...
                    href="/prestamos/materialDeportivo/inventario/register"
                    style={{
                      boxShadow: "3px 3px 10px rgba(0, 0, 0, 1)",
                      fontWeight: "bold",
                      maxWidth: "110px",
                  ...
                  <a
                    ...
                    href="/prestamos/materialDeportivo/search"
                    style={{
                      boxShadow: "3px 3px 10px rgba(0, 0, 0, 1)",
                      fontWeight: "bold",
                      maxWidth: "110px",
            ...
            >
              ...
              >
                <option value="idMaterialDeportivo">ID</option>
