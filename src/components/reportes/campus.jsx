...
const CampusReport = () => {
  ...
  const handleDownload = async () => {
    ...
    const url = `${reportesURL}/report/campus/download?fechaInicial=${fechaInicialFormat}&fechaFinal=${fechaFinalFormat}&tipo=pdf`;
    ...
    switch (response.status) {
      case 200:
        ...
        link.setAttribute("download", `Reporte Campus ${fechaHora}.pdf`);
