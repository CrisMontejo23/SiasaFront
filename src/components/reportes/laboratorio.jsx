...
const LaboratorioReport = () => {
  ...
  const handleDownload = async () => {
    ...
    const url = `${reportesURL}/report/laboratorio/download?fechaInicial=${fechaInicialFormat}&fechaFinal=${fechaFinalFormat}&tipo=pdf`;
    ...
    switch (response.status) {
      case 200:
        ...
        link.setAttribute("download", `Reporte Laboratorios ${fechaHora}.pdf`);
...
export default LaboratorioReport;
