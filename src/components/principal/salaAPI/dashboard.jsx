    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          `${principalURL}/salacomputo/page?pageNumber=${pageNumber}&pageSize=${pageSize}&sortBy=${sortBy}&sortOrder=${sortOrder}`
        );
        if (!response.ok) {
        ...
        <div>
          ...
          >
            ...
            >
              ...
              <option value="salaIngreso">Sala Ingresada</option>
